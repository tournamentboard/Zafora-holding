...
import { db, documentsTable } from "@/workplace/db/src/index.js";
import { eq, desc, count } from "drizzle-orm";
import { CreateDocumentBody, ListDocumentsQueryParams } from "@/workplace/api-zod/src/index.js";
...
router.patch("/documents/:id", async (req, res) => {
  ...
  const body = req.body as Partial<{ title: string; documentType: string; visibility: string; fileUrl: string | null; description: string | null }>;
